...
export async function execute(interaction, db) {
    ...
    const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId(`sign_accept_${signingId}`).setLabel('Accept').setStyle(ButtonStyle.Success), new ButtonBuilder().setCustomId(`sign_decline_${signingId}`).setLabel('Decline').setStyle(ButtonStyle.Danger));
    try {
