            ...
            confirmCollector?.on('collect', async (confirmInteraction) => {
                if (confirmInteraction.customId === 'cancel_delete') {
                    ...
                    try {
                        ...
                        const coLeaderToCheck = selectedGuild.coLeaderId;
                        const leaderToCheck = selectedGuild.leaderId;
                            ...
                            try {
                                ...
                                if (coLeaderToCheck) {
                                    ...
                                    if (coLeaderStillExists === 0) {
                                        ...
                                        if (coLeaderMember && coLeaderRole)
                                            await coLeaderMember.roles.remove(coLeaderRole).catch(() => { });
                                    }
                                }
