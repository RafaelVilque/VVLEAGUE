    ...
    try {
        ...
        const components = [
            new ContainerBuilder()
                ...
                .addTextDisplayComponents(new TextDisplayBuilder().setContent('🐑 **1v1 Wager**  \nCreate a solo wager.'))
                ...
                .addTextDisplayComponents(new TextDisplayBuilder().setContent('🐑 **2v2 Wager**  \nTeam up with a friend.'))
                .addActionRowComponents(new ActionRowBuilder().addComponents(new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setLabel('Start 2v2')
                .setCustomId('558e24f85ff142e69f7e05320a41c6bf')))
                .addSeparatorComponents(new SeparatorBuilder().setSpacing(SeparatorSpacingSize.Small).setDivider(true))
                .addTextDisplayComponents(new TextDisplayBuilder().setContent('Wager System')),
        ];
        await channel.send({
...
//# sourceMappingURL=wagerticket.js.map